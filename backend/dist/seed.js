...
async function seed() {
    try {
        ...
        await db_1.pool.query(`INSERT IGNORE INTO Admin (ID, nom, username, password, typeAdmin, actif) VALUES (1, 'Admin Seed', 'admin_seed@ecole.fr', 'password', 1, 1);`);
        // The other tables:
        const queries = [
